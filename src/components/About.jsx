import stackImage from '../assets/about/subasri-avatar.png';
import { aboutContent } from '../data/portfolioData';

const TechStackIcon = ({ label }) => (
  <div className="flex flex-col items-center gap-2">
    <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-black/85 border border-white/20 flex items-center justify-center shadow-[0_15px_35px_rgba(0,0,0,0.25)]">
      <span className="text-white text-lg md:text-xl font-black tracking-tight">{label}</span>
    </div>
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            <div className="bg-gray-900 w-full max-w-[280px] rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="w-full aspect-[3/4] overflow-hidden rounded-xl bg-gray-800 border-2 border-transparent">
                <img 
                  src={stackImage} 
                  alt="Subasri M - Aspiring .NET and React Developer" 
